...
public class NaiveSimilarityFinder extends JFrame {
	...
	public NaiveSimilarityFinder(RenderedImage reference, String basePath) throws IOException {
		...
		int[] ids = new int[others.length];
		for (int o = 0; o < others.length; o++) {
			String fileName = others[o].getName();
			int pos = fileName.lastIndexOf(".");
			if (pos > 0) {
				fileName = fileName.substring(0, pos);
			}
			ids[o] = Integer.parseInt(fileName);
		}
	...
	public static void main(String[] args) throws IOException {
		RenderedImage infEdge = ImageIO.read(new File("55.png"));
		NaiveSimilarityFinder nsf = new NaiveSimilarityFinder(infEdge, "champs");
		System.out.println(nsf.getItemId());
	}
